    ...
    return (
        <>
            <div className="lg:px-36 px-6 flex lg:flex-row flex-col-reverse">
                <div>
                    <h1 className="lg:text-[50px] text-3xl font-semibold text-beta-900">Your Blog Title Here.</h1>
                ...
                <div className="grid gap-10 lg:grid-cols-2 grid-cols-1 my-10 text-black">
                    ...
                    <div className="blogPostCardGlass overflow-hidden rounded-3xl">
                        ...
                        <div className="px-10 py-5">
                            <h1 className="mb-5 mt-4 text-2xl font-semibold">Lorem ipsum dolor</h1>
