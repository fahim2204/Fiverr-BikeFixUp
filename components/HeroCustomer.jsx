...
const HeroCustomer = () => {
    return (
        ...
        <div className="serviceMobileSecGleass px-5 lg:px-36 pt-10 lg:pt-36 mt-20 text-black flex flex-col justify-between items-center relative mb-20">
            <h2 className="text-beta-900 text-4xl font-semibold text-center mb-5">Customer Speaks</h2>
            <p className="text-center mb-12">Free text customers says about us</p>
            <div className="mt-28 grid grid-cols-1 gap-10 w-full sm:grid-cols-2 lg:grid-cols-3">
