...
const HeroCustomer = () => {
    return (
        ...
        <div className="p-10 bg-gradient-to-b from-white/20 to-white/0 bg-white/10 rounded-3xl shadow-md text-black relative mb-16">
            ...
            <div className="mt-28 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-16 md:gap-5">
                <div className="text-center bg-gradient-to-b from-white/20 to-white/0 bg-white/30 rounded-3xl shadow-md p-12 pt-24 relative" >
