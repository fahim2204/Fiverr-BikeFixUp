        ...
        <div className="serviceMobileSecGleass px-5 lg:px-36 py-[28px] align-top mt-10 lg:mt-48 text-black">
            <div className="flex flex-col lg:items-center lg:justify-between lg:px-28 lg:mb-10 relative ">
                ...
                <div className="text-center lg:mt-5 z-30 w-full ">
                    <p className="font-semibold md:text-2xl text-xl mb-4">Free Text Benefits</p>
                    <p className="font-medium md:text-2xl text-mdl"><span className="text-white">Rs.100</span> off services for first time</p>
                    <h2 className="font-semibold text-2xl sm:text-4xl text-beta-900">Get your bike serviced</h2>
                </div>
            </div>
            <div className="mt-10">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div className="benifitSectionCardGlass appServiceSecLeftCard pl-3 pr-2 lg:px-10 py-2 flex justify-around items-center min-h-20">
                        ...
                        <div className="w-full">
                            <p className="md:text-lg text-sm font-semibold text-beta-900">10 days Free Service Guarantee</p>
                    ...
                    <div className="benifitSectionCardGlass appServiceSecLeftCard pl-3 pr-2 lg:px-10 py-2 flex justify-around items-center min-h-20">
                        ...
                        <div className="w-full">
                            <p className="md:text-lg text-sm font-semibold text-beta-900">Free Pickup & Drop service</p>
                    ...
                    <div className="benifitSectionCardGlass appServiceSecLeftCard pl-3 pr-2 lg:px-10 py-2 flex justify-around items-center min-h-20">
                        ...
                        <div className="w-full">
                            <p className="md:text-lg text-sm font-semibold text-beta-900">Transparent & Competitive Pricing</p>
                    ...
                    <div className="benifitSectionCardGlass appServiceSecLeftCard pl-3 pr-2 lg:px-10 py-2 flex justify-around items-center min-h-20">
                        ...
                        <div className="w-full">
                            <p className="md:text-lg text-sm font-semibold text-beta-900">Trained & Experts Mechanics</p>
